...
class ResultsExport implements FromQuery, WithHeadings, WithMapping, WithStyles, ShouldAutoSize
{
    ...
    public function map($result): array
    {
        return [
            ...
            $result->contrato_empresa_id,
            $result->contrato_empresa_nombre,
            $result->contrato_arp,
            $result->contrato_afp,
            $result->contrato_cargo,
            $result->contrato_ultimo_pago,
            $result->contrato_ingreso_base,
            $result->contrato_cotizacion_pagada,
            $result->contrato_periodos_mora,
            $result->contrato_fecha_primer_pago,
            $result->status,
