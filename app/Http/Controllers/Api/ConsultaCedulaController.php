...
class ConsultaCedulaController extends Controller
{
    ...
    public function show(string $cedula): JsonResponse
    {
        ...
        $data = $resultados->map(fn (ConsultaResult $r) => [
            ...
            'documentos_faltantes'       => $r->documentos_faltantes,
            ...
            'antiguedad_otra_eps'        => $r->antiguedad_otra_eps,
            'direccion'                  => $r->direccion,
            'telefono'                   => $r->telefono,
            'ciudad'                     => $r->ciudad,
            'ips_medica_asignada'        => $r->ips_medica_asignada,
            'ips_odontologica_asignada'  => $r->ips_odontologica_asignada,
            'contrato_empresa_id'        => $r->contrato_empresa_id,
            'contrato_empresa_nombre'    => $r->contrato_empresa_nombre,
            'contrato_arp'               => $r->contrato_arp,
            'contrato_afp'               => $r->contrato_afp,
            'contrato_cargo'             => $r->contrato_cargo,
            'contrato_ultimo_pago'       => $r->contrato_ultimo_pago,
            'contrato_ingreso_base'      => $r->contrato_ingreso_base,
            'contrato_cotizacion_pagada' => $r->contrato_cotizacion_pagada,
            'contrato_periodos_mora'     => $r->contrato_periodos_mora,
            'contrato_fecha_primer_pago' => $r->contrato_fecha_primer_pago,
            'status'                     => $r->status,
